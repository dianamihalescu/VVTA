...
public class EmployeeMock implements EmployeeRepositoryInterface {
	...
	public EmployeeMock() {
		...
		Employee Ionel = new Employee("Marius", "Pacuraru", CNP, DidacticFunction.ASSISTENT, 2500d);
		...
		Employee Mihaela = new Employee("Dodel", "Pacuraru", CNP, DidacticFunction.ASSISTENT, 2500d);
